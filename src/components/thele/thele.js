...
export default function Thele() {
  return (
    <section className="pt-5 md:px-5 sm:px-5 sm:!pt-4" id="thele">
      <div className="bg-white px-12 py-6 rounded-xl max-w-[850px] mx-auto flex flex-col gap-3 sm:px-6 text-justify">
